...
\begin{figure}[t]
    \begin{subfigure}{\columnwidth}
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=0.8\linewidth]{multipole_expansion.pdf}}
    \end{subfigure}

    \begin{subfigure}{\columnwidth}
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=0.8\linewidth]{local_expansion.pdf}}
    \end{subfigure}
