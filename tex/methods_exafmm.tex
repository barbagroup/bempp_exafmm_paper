...
The classic \fmm uses a truncated analytical expansion to approximate far-field interactions, whereas its kernel-independent variant KIFMM uses equivalent charges.
