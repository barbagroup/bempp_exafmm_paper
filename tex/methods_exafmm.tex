...
\begin{figure*}
    \begin{subfigure}{\columnwidth}
        \centering
        \subcaption{}
        \makebox[\textwidth][c]{\includegraphics[width=0.7\linewidth]{near_far_decomposition.pdf}}
        \label{fig:near_far_decomp}
    \end{subfigure}
    \begin{subfigure}{\columnwidth}
        \centering
        \subcaption{}
        \makebox[\textwidth][c]{\includegraphics[width=\linewidth]{fmm_sketch.pdf}}
        \label{fig:fmm_sketch}
    \end{subfigure}
    \begin{subfigure}{\columnwidth}
        \centering
        \subcaption{}
        \makebox[\textwidth][c]{\includegraphics[width=0.7\linewidth]{multipole_expansion.pdf}}
        \label{fig:multipole}
    \end{subfigure}
    \begin{subfigure}{\columnwidth}
        \centering
        \subcaption{}
        \makebox[\textwidth][c]{\includegraphics[width=0.7\linewidth]{local_expansion.pdf}}
        \label{fig:local}
    \end{subfigure}
