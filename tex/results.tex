...
Other parameters are listed in Table \ref{tab:sim_params_convergence}.
...
Next, we tested our code on a realistic structure - bovine pancreatic trypsin inhibitor (PDB code 5PTI).
...
In this section, we investigate our software performance using a spherical molecule.
