...
In the absence of an analytical solution, it is necessary to complete a grid convergence study with each solver to obtain an extrapolated solution using Richardson extrapolation, based on which we can compute the accuracy.
...
\begin{figure*}
    ...
    Errors are measured against extrapolated solution.
    }
