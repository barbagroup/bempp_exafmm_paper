...
To further validate Bempp-Exafmm, we compared our results with well-established software: the finite-difference version of APBS, using 5PTI and 8 other molecules.
...
In APBS, we tweaked [?] to ensure that three grid spacings are refined with a factor of 2.
All mesh sizes are availabe in Appendix \ref{sec:apbs_mesh}.
...
The difference of the extrapolated solvation energy between Bempp and APBS varies between 0.8\% and 1.8\% across all cases.
We also compared our results with MIBPB only using the finest mesh, and the details can be found in Appendix \ref{sec:comp_mibpb}.
