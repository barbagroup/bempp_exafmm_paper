...
\begin{figure*}
    \begin{subfigure}{\columnwidth}
        \centering
        \subcaption{}
        \makebox[\textwidth][c]{\includegraphics[width=\linewidth]{derivative_interior_eig.pdf}}
        \label{fig:derivative_interior_eig}
    \end{subfigure}
    \begin{subfigure}{\columnwidth}
        \centering
        \subcaption{}
        \makebox[\textwidth][c]{\includegraphics[width=\linewidth]{derivative_exterior_eig.pdf}}
...
\begin{figure*}
    \begin{subfigure}{\columnwidth}
        \centering
        \subcaption{}
        \makebox[\textwidth][c]{\includegraphics[width=0.7\linewidth]{sketch_sphere_convergence.pdf}}
        \label{fig:sketch_sphere_convergence}
    \end{subfigure}
    \begin{subfigure}{\columnwidth}
        \centering
        \subcaption{}
        \makebox[\textwidth][c]{\includegraphics[width=0.7\linewidth]{5PTI.png}}
        \label{fig:5PTI_structure}
    \end{subfigure}
    \begin{subfigure}{\columnwidth}
        \centering
        \subcaption{}
        \makebox[\textwidth][c]{\includegraphics[width=\linewidth]{sphere_convergence.pdf}}
        \label{fig:sphere_convergence}
    \end{subfigure}
    \begin{subfigure}{\columnwidth}
        \centering
        \subcaption{}
        \makebox[\textwidth][c]{\includegraphics[width=\linewidth]{5PTI_convergence.pdf}}
        \label{fig:5PTI_convergence}
    \end{subfigure}
    \caption{Two mesh refinement studies using a spherical molecule and a real biomolecule: bovine pancreatic trypsin inhibitor (PDB code 5PTI).
    \textbf{a}, Sketch of a spherical molecule with an off-center unit charge at $(1,1,1)$.
    \textbf{b}, Structure of 5PTI.
...
\begin{figure*}
    \begin{subfigure}{\columnwidth}
        \centering
        \subcaption{}
        \makebox[\textwidth][c]{\includegraphics[width=\linewidth]{sphere_assembly_time.pdf}}
        \label{fig:sphere_assembly_time}
    \end{subfigure}
    \begin{subfigure}{\columnwidth}
        \centering
        \subcaption{}
        \makebox[\textwidth][c]{\includegraphics[width=\linewidth]{sphere_fmm.pdf}}
    ...
    \end{subfigure}
    \caption{Performance results using a spherical molecule with 100 random charges inside.
    6 regular quadrature points were used per element and the \fmm expansion order was set to 5 to achieve around 5 digits of accuracy.
    \textbf{a}, Assembly time with respect to problem size $N$.
    \textbf{b}, The average time of 1 Laplace \fmm evaluation and 1 modified Helmholtz evaluation across all iterations in GMRES with respect to problem size N using direct formulation.
    ...
    \textbf{e}, Overall memory consumption in GB for both direct and derivative formulation.}
\end{figure*}
...
\begin{figure*}
    \begin{subfigure}{0.35\textwidth}
        \centering
        \subcaption{}
        \includegraphics[width=\linewidth]{6CO8_assembly.png}
