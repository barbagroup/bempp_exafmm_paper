...
\paragraph{Comparison with existing codes} \label{comparison}
To further validate Bempp-Exafmm, we compare our results with well-established software: the finite-difference version of APBS, using 5PTI and 8 other molecules.
For each molecule, we created three successive meshes for each software to study the convergence.
For Bempp-Exafmm, We used \texttt{Nanoshaper} to generate three surface meshes with the element density set to 4, 8, 16 per square \AA, respectively.
In APBS, we tweaked [?] to ensure three grid spacings are refined with a factor of 2.
Other parameters are the same as our previous grid-convergence study.

Table \ref{tab:APBS_result} presents the convergence results of both codes using a set of molecules.
We obtained an extrapolated value of the solvation energy, serving as the reference value, for each molecule.
As expected, we observe linear convergence with both Bempp and APBS in each case.
The relative difference of the extrapolated solvation energy between Bempp and APBS is around 2\% across all cases.

\begin{table*}[]
    \centering
    \begin{tabular}{c|ccc|cc|ccc|cc}
         & \multicolumn{5}{c|}{APBS}                                                                    & \multicolumn{5}{c}{Bempp}                                                                   \\
         & \multicolumn{3}{c|}{Error}     & \multirow{2}{*}{$\Delta G_{solv}$} & \multirow{2}{*}{Order} & \multicolumn{3}{c|}{Error}     & \multirow{2}{*}{$\Delta G_{solv}$} & \multirow{2}{*}{Order} \\
    ID   & coarse   & medium   & fine     &                                    &                        & coarse   & medium   & fine     &                                    &                        \\ \hline
    1A2S & 5.25e-02 & 2.40e-02 & 1.10e-02 & -456.56                            & 1.13                   & 4.21e-02 & 1.93e-02 & 8.86e-03 & -461.25                            & 1.12                   \\
    1A63 & 4.51e-02 & 1.88e-02 & 7.82e-03 & -559.39                            & 1.26                   & 5.82e-02 & 2.60e-02 & 1.16e-02 & -567.24                            & 1.16                   \\
    1A7M & 4.13e-02 & 1.88e-02 & 8.53e-03 & -524.29                            & 1.14                   & 4.93e-02 & 2.24e-02 & 1.02e-02 & -531.48                            & 1.14                   \\
    1AJJ & 4.40e-02 & 1.33e-02 & 4.00e-03 & -266.15                            & 1.73                   & 2.75e-02 & 1.12e-02 & 4.59e-03 & -268.67                            & 1.29                   \\
    1F6W & 6.45e-02 & 2.78e-02 & 1.20e-02 & -1277.51                           & 1.21                   & 4.18e-02 & 1.80e-02 & 7.76e-03 & -1301.08                           & 1.22                   \\
    1R69 & 4.31e-02 & 2.10e-02 & 1.02e-02 & -261.02                            & 1.04                   & 5.09e-02 & 2.34e-02 & 1.08e-02 & -265.02                            & 1.12                   \\
    1SVR & 5.28e-02 & 2.21e-02 & 9.28e-03 & -393.45                            & 1.25                   & 6.48e-02 & 2.89e-02 & 1.29e-02 & -398.83                            & 1.16                   \\
    1VJW & 3.09e-02 & 1.45e-02 & 6.77e-03 & -297.06                            & 1.09                   & 4.92e-02 & 2.23e-02 & 1.01e-02 & -302.50                            & 1.14                   \\
    5PTI & 3.68e-02 & 1.38e-02 & 5.14e-03 & -311.69                            & 1.42                   & 5.12e-02 & 2.23e-02 & 9.67e-03 & -314.34                            & 1.20                  
    \end{tabular}
    \caption{Convergence results of the solvation energy of 9 molecules using Bempp and APBS.
