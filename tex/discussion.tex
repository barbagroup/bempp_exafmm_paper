...
Our approach also becomes useful as part of existing computational workflows, for example, to compute solvation free energies in MMPBSA methods \cite{WangETal2018}.
The Poisson-Boltzmann model has known limitations, being the rigid approximation of the solute a specially difficult one at large scales. However, the electrostatic potential and polar solvation free energy still give valuable information \cite{LiLiZhangAlexov2012} for analysis. 
