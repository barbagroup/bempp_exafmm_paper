...
However, most of them are not suitable to handle large structures at a decent accuracy on a workstation due to the excessive time and memory cost, as suggested by the scaling in Figure \ref{fig:performance_comparison_apbs}.
